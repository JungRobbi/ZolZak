...
class TessTerrainShader : public Shader
{
public:
	TessTerrainShader();
	virtual ~TessTerrainShader();
...
//
//	void PrepareShadowMap(ID3D12GraphicsCommandList* pd3dCommandList, LIGHT* light);
//
//	virtual void Render(ID3D12GraphicsCommandList* pd3dCommandList, Camera* pCamera);
//
//protected:
...
//
//protected:
//	TOOBJECTSPACEINFO* m_pToLightSpace;
//	ID3D12Resource* m_pd3dcbToLightSpace = NULL;
//	TOOBJECTSPACEINFO* m_pcbMappedToLightSpace = NULL;
//};
//
